# Enumer [![GoDoc](https://godoc.org/github.com/AlacrityDaft/enumer?status.svg)](https://godoc.org/github.com/AlacrityDaft/enumer) [![Go Report Card](https://goreportcard.com/badge/github.com/AlacrityDaft/enumer)](https://goreportcard.com/report/github.com/AlacrityDaft/enumer) [![GitHub Release](https://img.shields.io/github/release/AlacrityDaft/enumer.svg)](https://github.com/AlacrityDaft/enumer/releases)

Enumer is a tool to generate Go code that adds useful methods to Go enums (constants with a specific type).
It started as a fork of [Rob Pike’s Stringer tool](https://godoc.org/golang.org/x/tools/cmd/stringer)
maintained by [Álvaro López Espinosa](https://github.com/alvaroloes/enumer). 
This was again forked here as (https://github.com/AlacrityDaft/enumer) picking up where Álvaro left off.
...
For more information, see:
        http://godoc.org/github.com/AlacrityDaft/enumer
Flags:
  -addprefix string
...
```golang
//go:generate go run github.com/AlacrityDaft/enumer -type=YOURTYPE
```
...
import (
    "errors"
    "github.com/AlacrityDaft/enumer/enumerrs"
)
