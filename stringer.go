...
//
// Please visit http://github.com/AlacrityDaft/enumer for a comprehensive documentation
package main
...
func Usage() {
	...
	_, _ = fmt.Fprintf(os.Stderr, "\thttp://godoc.org/github.com/AlacrityDaft/enumer\n")
...
func main() {
	...
	if opts.useTypedErrors {
		g.Printf("\t\"errors\"\n")
		g.Printf("\t\"github.com/AlacrityDaft/enumer/enumerrs\"\n")
	}
	g.Printf("\t\"fmt\"\n")
	g.Printf("\t\"strings\"\n")
	if opts.includeSQL {
